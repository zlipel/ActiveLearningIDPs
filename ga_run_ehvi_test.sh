...
CANDIDATES_DIR="$BASE_DIR/candidates_${EHVI}_${EXPLORE}_${TRANSFORM}"
MODEL_PATH="/home/zl4808/PROJECTS/MODEL_COMPARISON/$MODEL/MODELS"
SEQ_FILE="$ITERATION_DIR/seq_gen${ITER}_TEMP_${EHVI}_${EXPLORE}_${TRANSFORM}.txt"
...
for CAND_ID in {1..96}; do
    ...
    srun  -n 1 --exclusive python /home/zl4808/PROJECTS/MODEL_COMPARISON/ga_iterk_selection_testing.py \
        --gen_folder "$BASE_DIR" \
...
python /home/zl4808/PROJECTS/MODEL_COMPARISON/select_best_sequence.py \
    --input_folder "$BASE_DIR/candidates_${EHVI}_${EXPLORE}_${TRANSFORM}" \
...
touch "$CHILDREN_DIR/child_seq_${SEQ_ID}_done_${EXPLORE}_${TRANSFORM}.flag"

echo "Child sequence $SEQ_ID in iteration $ITER completed successfully."

mv logs/seq_num_${SLURM_JOB_ID}.out $LOG_DIR/seq_${SEQ_ID}_${TRANSFORM}.out
mv logs/seq_num_${SLURM_JOB_ID}.err $LOG_DIR/seq_${SEQ_ID}_${TRANSFORM}.err
